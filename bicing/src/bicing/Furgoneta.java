...
public class Furgoneta {
	...
	private Estacion estacioE;
	private Estacion estacioP1;
	private Estacion estacioP2;
	private Integer np1;
	private Integer np2;
	
	public Furgoneta(Estacion estacioE, Estacion estacioP1, Estacion estacioP2, Integer np1, Integer np2) {
		super();
	...
	public Integer demandaE(){
		return estacioE.getDemanda();
	}
	
	public Integer demandaP1(){
		return estacioP1.getDemanda();
	}
	public Integer demandaP2(){
		return estacioP2.getDemanda();
	}
