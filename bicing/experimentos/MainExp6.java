...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		int k = 1;
		double lam = 0.1;
		FileWriter fichero1 = new FileWriter("exp6.txt");
		fichero1.write("Semilla Demanda BeneficioReal Tiempo\n");
		System.out.print("Semilla Demanda BeneficioReal Tiempo\n");
		for (int j = 0; j < semillas.length; ++j) {
			for (int i = 0; i <=1; ++i) {
				...
				fichero1.write(seed + " " + demanda + " " + (money - gas) + " " + time + "\n");
				System.out.print(seed + " " + demanda + " "  + (money - gas) + " " + time + "\n");
			}
		}
		fichero1.close();
	}
